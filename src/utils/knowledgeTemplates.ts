...
export const KNOWLEDGE_TEMPLATES: KnowledgeTemplate[] = [
  ...
  },
  {
    ...
    fields: [
      ...
      { label: '摘录类型', sourceType: 'excerptType', aliases: ['摘录类型', '引用类型', '素材类型'], fieldTypeHint: '单选/文本' },
  ...
  },
  {
    ...
    fields: [
      ...
      { label: '摘录类型', sourceType: 'excerptType', aliases: ['摘录类型', '素材类型', '引用类型'], fieldTypeHint: '单选/文本' },
